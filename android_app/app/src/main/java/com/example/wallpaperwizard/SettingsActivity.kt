...
class SettingsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        settings.registerOnSharedPreferenceChangeListener { _, p1 ->
            if (settings.getBoolean(p1, false)) {
                ...
                val downloadWorkRequest: PeriodicWorkRequest =
                    PeriodicWorkRequestBuilder<WallpaperChangerWorker>(24, TimeUnit.HOURS)
                        ...
                        .build()
                WorkManager.getInstance(this).enqueueUniquePeriodicWork("periodic_updater", ExistingPeriodicWorkPolicy.UPDATE, downloadWorkRequest)
